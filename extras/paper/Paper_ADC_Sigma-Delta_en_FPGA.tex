...
%\caption{Respuesta modulador en la banda de paso}
%\label{fig_5}
%\centering
%\includegraphics[width=2.5in]{Respuesta_Ruido_BP_Modulador}
%\caption{Respuesta ruido en la banda de paso}
%\label{fig_6}
\centering
...
\bibitem{DSP:Pro-Man}
J.G.~Proakis and D.G.~Manolakis \emph{Digital Signal Processing Principles, Algorithms, and Aplicattions}, 3rd~ed.\hskip 1em plus
	0.5em minus 0.4em\relax Patrice-Hall, 1996.
